...
def test_signup_registers_participant(client):
    ...
    registered_activity = client.get("/activities").json()[activity_name]
    assert email in registered_activity["participants"]
...
def test_unregister_removes_participant(client):
    ...
    registered_activity = client.get("/activities").json()[activity_name]
    assert email not in registered_activity["participants"]
